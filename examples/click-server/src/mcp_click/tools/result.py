...
def register_tools(server: FastMCP, backend) -> None:
    """Register result tools with the server."""

    @server.tool()
    async def result_output(
        init_runner: str | None = None,
        init_stdout_bytes: str | None = None,
        init_stderr_bytes: str | None = None,
        init_output_bytes: str | None = None,
        init_return_value: str | None = None,
        init_exit_code: int | None = None,
        init_exception: str | None = None,
    ) -> str:
        """The terminal output as unicode string, as the user would see it."""
        # Instance method: testing.Result.output
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "testing")
        cls = getattr(mod, "Result")
        kwargs = {}
        method_attr = inspect.getattr_static(cls, "output")
        if isinstance(method_attr, (staticmethod, classmethod)):
            # Static/class method — call directly on the class
            result = getattr(cls, "output")(**kwargs)
        else:
            # Instance method — auto-instantiate the class
            init_kwargs = {}
            if init_runner is not None:
                init_kwargs["runner"] = init_runner
            if init_stdout_bytes is not None:
                init_kwargs["stdout_bytes"] = init_stdout_bytes
            if init_stderr_bytes is not None:
                init_kwargs["stderr_bytes"] = init_stderr_bytes
            if init_output_bytes is not None:
                init_kwargs["output_bytes"] = init_output_bytes
            if init_return_value is not None:
                init_kwargs["return_value"] = init_return_value
            if init_exit_code is not None:
                init_kwargs["exit_code"] = init_exit_code
            if init_exception is not None:
                init_kwargs["exception"] = init_exception
            instance = _get_or_create_instance(mod, "Result", **init_kwargs)
            result = getattr(instance, "output")(**kwargs)
        if inspect.isawaitable(result):
            result = await result
        return str(result) if result is not None else "OK"

    @server.tool()
    async def result_stderr(
        init_runner: str | None = None,
        init_stdout_bytes: str | None = None,
        init_stderr_bytes: str | None = None,
        init_output_bytes: str | None = None,
        ...
        # Instance method: testing.Result.stderr
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "testing")
        cls = getattr(mod, "Result")
        kwargs = {}
        method_attr = inspect.getattr_static(cls, "stderr")
        if isinstance(method_attr, (staticmethod, classmethod)):
            # Static/class method — call directly on the class
            result = getattr(cls, "stderr")(**kwargs)
        else:
            # Instance method — auto-instantiate the class
            init_kwargs = {}
            if init_runner is not None:
            ...
            if init_exception is not None:
                init_kwargs["exception"] = init_exception
            instance = _get_or_create_instance(mod, "Result", **init_kwargs)
            result = getattr(instance, "stderr")(**kwargs)
        if inspect.isawaitable(result):
            result = await result
        return str(result) if result is not None else "OK"

    @server.tool()
    async def result_stdout(
        init_runner: str | None = None,
        init_stdout_bytes: str | None = None,
        init_stderr_bytes: str | None = None,
        init_output_bytes: str | None = None,
        ...
        # Instance method: testing.Result.stdout
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "testing")
        cls = getattr(mod, "Result")
        kwargs = {}
        method_attr = inspect.getattr_static(cls, "stdout")
        if isinstance(method_attr, (staticmethod, classmethod)):
            # Static/class method — call directly on the class
            result = getattr(cls, "stdout")(**kwargs)
        else:
            # Instance method — auto-instantiate the class
            init_kwargs = {}
            if init_runner is not None:
            ...
            if init_exception is not None:
                init_kwargs["exception"] = init_exception
            instance = _get_or_create_instance(mod, "Result", **init_kwargs)
            result = getattr(instance, "stdout")(**kwargs)
        if inspect.isawaitable(result):
            result = await result
        return str(result) if result is not None else "OK"
