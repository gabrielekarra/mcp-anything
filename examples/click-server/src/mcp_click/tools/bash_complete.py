...
def register_tools(server: FastMCP, backend) -> None:
    ...
    async def bash_complete_format_completion(
        ...
        if isinstance(method_attr, (staticmethod, classmethod)):
            ...
            init_kwargs = {}
            instance = _get_or_create_instance(mod, "BashComplete", **init_kwargs)
