...
def register_tools(server: FastMCP, backend) -> None:
    """Register query tools with the server."""

    @server.tool()
    async def get_app_dir(
        app_name: str,
        roaming: bool | None = True,
        force_posix: bool | None = False,
    ) -> str:
        """Returns the config folder for the application.  The default behavior"""
        # Call function via CLI backend: utils.py::get_app_dir
    ...
    @server.tool()
    async def get_best_encoding(
        stream: str,
    ) -> str:
        """Returns the default stream encoding if not found."""
        # Call function via CLI backend: _compat.py::get_best_encoding
        return await backend.run_function_as_cli(
            "_compat.py",
            "get_best_encoding",
            stream=stream,
    ...
    async def get_binary_stream(
        ...
        # Call function via CLI backend: utils.py::get_binary_stream
        return await backend.run_function_as_cli(
            "utils.py",
            "get_binary_stream",
            name=name,
    ...
    @server.tool()
    async def get_completion_class(
        shell: str,
    ) -> str:
        """Look up a registered :class:`ShellComplete` subclass by the name"""
        # Call function via CLI backend: shell_completion.py::get_completion_class
        return await backend.run_function_as_cli(
            "shell_completion.py",
    ...
    async def get_current_context(
        silent: str | None = "False",
    ) -> str:
        """Get current context"""
        # Call function via CLI backend: globals.py::get_current_context
        return await backend.run_function_as_cli(
            "globals.py",
            "get_current_context",
            silent=silent,
    ...
    @server.tool()
    async def get_text_stderr(
        encoding: str | None = None,
        errors: str | None = None,
    ) -> str:
        """Get text stderr"""
        # Call function via CLI backend: _compat.py::get_text_stderr
        return await backend.run_function_as_cli(
            "_compat.py",
            "get_text_stderr",
            encoding=encoding,
    ...
    @server.tool()
    async def get_text_stdin(
        encoding: str | None = None,
        errors: str | None = None,
    ) -> str:
        """Get text stdin"""
        # Call function via CLI backend: _compat.py::get_text_stdin
        return await backend.run_function_as_cli(
            "_compat.py",
            "get_text_stdin",
            encoding=encoding,
    ...
    @server.tool()
    async def get_text_stdout(
        encoding: str | None = None,
        errors: str | None = None,
    ) -> str:
        """Get text stdout"""
        # Call function via CLI backend: _compat.py::get_text_stdout
        return await backend.run_function_as_cli(
            "_compat.py",
            "get_text_stdout",
            encoding=encoding,
    ...
    async def get_text_stream(
        ...
        # Call function via CLI backend: utils.py::get_text_stream
        return await backend.run_function_as_cli(
            "utils.py",
            "get_text_stream",
            name=name,
