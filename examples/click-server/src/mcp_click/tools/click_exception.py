    ...
    async def click_exception_show(
        ...
        if isinstance(method_attr, (staticmethod, classmethod)):
            ...
            if init_message is not None:
                init_kwargs["message"] = init_message
            instance = _get_or_create_instance(mod, "ClickException", **init_kwargs)
