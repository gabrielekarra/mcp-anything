...
def register_tools(server: FastMCP, backend) -> None:
    ...
    async def argument_add_to_parser(
        parser: str,
        ctx: str,
        init_param_decls: str | None = None,
    ) -> str:
        """Add to parser"""
        # Instance method: core.Argument.add_to_parser
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "core")
        cls = getattr(mod, "Argument")
        kwargs = {}
        ...
        if isinstance(method_attr, (staticmethod, classmethod)):
            ...
            init_kwargs = {}
            if init_param_decls is not None:
                init_kwargs["param_decls"] = init_param_decls
            instance = _get_or_create_instance(mod, "Argument", **init_kwargs)
    ...
    async def argument_get_error_hint(
        ...
        """Get error hint"""
        # Instance method: core.Argument.get_error_hint
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "core")
        cls = getattr(mod, "Argument")
        kwargs = {}
    ...
    async def argument_get_usage_pieces(
        ...
        """Get usage pieces"""
        # Instance method: core.Argument.get_usage_pieces
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "core")
        cls = getattr(mod, "Argument")
        kwargs = {}
    ...
    async def argument_human_readable_name(
        ...
        """Human readable name"""
        # Instance method: core.Argument.human_readable_name
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "core")
        cls = getattr(mod, "Argument")
        kwargs = {}
    ...
    async def argument_make_metavar(
        ...
        """Make metavar"""
        # Instance method: core.Argument.make_metavar
        _setup_import_path("/tmp/click/src/click")
        mod = _load_source_module("/tmp/click/src/click", "core")
        cls = getattr(mod, "Argument")
        kwargs = {}
